...
CreateDialog.Project.prototype.initFormConfig = function() {
  ...
  config.addColumnConfiguration(CreateDialog.Project.columnIndices.billable,
...
CreateDialog.User.prototype.initFormConfig = function() {
  ...
  config.addColumnConfiguration(CreateDialog.User.columnIndices.cost, {
	    title: "Cost",
	    editable: true,
	    get: UserModel.prototype.getCost,
	    edit: {
	      editor: "Text",
	      required: true,
	      visualizeRequired: true,
	      size: '20ex',
	      set: UserModel.prototype.setCost
	    }
	  });
