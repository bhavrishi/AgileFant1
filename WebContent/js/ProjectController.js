...
ProjectController.columnNames = [ "name", "reference", "startDate", "endDate",
		"plannedSize", "effortSpent", "baselineLoad", "assignees", "description","billable" ];
...
ProjectController.columnConfigs = {
	...
	billable : {title : "Billable",
		get : ProjectModel.prototype.getBillable,
		editable : true,
		visualizedEditable: true,
		edit : {
			editor : "Selection",
			...
			editable : true,
			set : ProjectModel.prototype.setBillable,
...
ProjectController.prototype.initializeProjectDetailsConfig = function() {
	...
	config.addColumnConfiguration(ProjectController.columnIndices.billable,
			ProjectController.columnConfigs.billable);
