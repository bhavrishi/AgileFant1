...
TasksWithoutStoryController.columnConfig.billable = {
		minWidth : 80,
	    autoScale : true,
	    cssClass : 'task-row',
	    title : "Billable",
...
TasksWithoutStoryController.prototype._addColumnConfigs = function(config) {
  ...
  config.addColumnConfiguration(TaskController.columnIndices.billable, TasksWithoutStoryController.columnConfig.billable);
